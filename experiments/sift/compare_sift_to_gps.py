...
_BASE = ROOT / "experiments" / "sift" / "results" / "sift_baseline"
SIFT_PATH = _BASE / "sift_gps_estimates" / "sift_gps_estimates.csv"
GPS_PATH = _BASE / "gps" / "gps_data.csv"
OUTPUT_PATH = _BASE / "sift_gps_estimates" / "sift_gps_error_metrics.csv"
