...
SIFT_PATH = Path("results/sift_baseline/sift_gps_estimates/sift_gps_estimates.csv")
GPS_PATH = Path("results/sift_baseline/gps/gps_data.csv")
OUTPUT_PATH = Path("results/sift_baseline/sift_gps_estimates/sift_gps_error_metrics.csv")
