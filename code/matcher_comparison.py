...
Estimate CSVs live in results/matcher_comparison/estimates/ (copied from the
teammates' branches: SIFT -> initial-sift-baseline, RoMa -> feature/roma,
...
EST_DIR = ROOT / "results" / "matcher_comparison" / "estimates"
